...
async function loadLogoDataUrl(): Promise<string | null> {
  try {
    // lockup-dark.png — the PRINT version, with dark wordmark text. Every document
    // letterhead uses it (invoice, JobPDF, Borescoping, DRI). lockup-white.png is the
    ...
    const res = await fetch('/brand/lockup-dark.png')
